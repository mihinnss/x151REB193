...
<div id='aaa'>Urraaaaaaaaaa</div>
<script>
function Uzspied()
{
document.getElementById('aaa').innerHTML('Paldies');
}
</script>
<h1 style="background-color:purple;text-align:center;">Majaslapas testins </h1>

<p>SVG attela izveide</p>
...
<p style="background-color:purple;">foto ievietosanai</P>

<h2 style"background-color:purple;text-align:right;">Bumeris</h2>

<img src="http://s1.cdn.autoevolution.com/images/news/gallery/what-to-look-for-when-buying-a-bmw-e$
<h4>Gif attela ievietosana</h4>
<h3 style="text-align:center;>Gifs</h3>
<a data-ved="0ahUKEwjAycWs7pTLAhVICpoKHYQYB4YQjRwIBw" href="/url?sa=i&amp;rct=j&amp;q=&amp;esrc=s&$
</a>
<h1 id='aaa' onClick=Uzspied()>Shemas Liksanas video!</h1>
<iframe width="680" height="480" src="https://www.youtube.com/embed/DGI5fzda9f8" frameborder="0" a$
<h2 style"background-color:purple;text-align:center;">Rezistors</h2>
<img src="rezistors.png" style="width:500px;height:400px;">
<img src="rezistors_2.png" style="width:500px;height:400px;">
